...
if __name__ == "__main__":
    ...
    poule=Poule('A')
    E1=Equipe('EST',5,0,2,3,0,4,6)
    E2=Equipe('CSS',5,0,5,0,0,15,2)
    E3=Equipe('JWT',5,0,1,4,0,2,6)
    E4=Equipe('XSS',5,0,3,2,0,6,1)
    ...
    for e in poule.Equipes:
        ...
        print('Avg Goals: %s' % e.Goal_Average())
    e1,e2=poule.Qualification()
    print("Eqipes Qualifer E1={} ,E2={}".format(e1,e2))
    for e in poule.Equipes:
        e.Affichage()